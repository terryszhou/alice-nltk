...
export const MouseTail = () => {
  ...
  return (
    <Stack
      ...
      <Text fontSize={"100%"} pl={"9rem"} filter={pinkShadow} color={"rgb(173,123,223)"}>{selectedText[2]}</Text>
      <Text fontSize={"100%"} pl={"10rem"} filter={pinkShadow} color={"rgb(173,123,223)"}>{selectedText[3]}</Text>
      <Text fontSize={"100%"} pl={"11rem"} filter={pinkShadow} color={"rgb(173,123,223)"}>{selectedText[4]}</Text>
      <Text fontSize={"100%"} pl={"10rem"} filter={pinkShadow} color={"rgb(173,123,223)"}>{selectedText[5]}</Text>
      ...
      <Text fontSize={"100%"} pl={"6rem"} filter={purpleShadow} color={"rgb(159,43,122)"}>{selectedText[9]}</Text>
      <Text fontSize={"90%"} pl={"6rem"} filter={purpleShadow} color={"rgb(159,43,122)"}>{selectedText[10]}</Text>
      <Text fontSize={"90%"} pl={"6.5rem"} filter={purpleShadow} color={"rgb(159,43,122)"}>{selectedText[11]}</Text>
      <Text fontSize={"90%"} pl={"8rem"} filter={purpleShadow} color={"rgb(159,43,122)"}>{selectedText[12]}</Text>
      ...
      <Text fontSize={"80%"} pl={"17rem"} filter={purpleShadow} color={"rgb(159,43,122)"}>{selectedText[21]}</Text>
      <Text fontSize={"80%"} pl={"15rem"} filter={purpleShadow} color={"rgb(159,43,122)"}>{selectedText[22]}</Text>
      <Text fontSize={"80%"} pl={"13.5rem"} filter={purpleShadow} color={"rgb(159,43,122)"}>{selectedText[23]}</Text>
      ...
      <Text fontSize={"70%"} pl={"12rem"} filter={pinkShadow} color={"rgb(173,123,223)"}>{selectedText[28]}</Text>
      <Text fontSize={"70%"} pl={"11rem"}>{selectedText[29]}</Text>
      <Text fontSize={"70%"} pl={"9.5rem"} filter={pinkShadow} color={"rgb(173,123,223)"}>{selectedText[30]}</Text>
      <Text fontSize={"70%"} pl={"8rem"} filter={pinkShadow} color={"rgb(173,123,223)"}>{selectedText[31]}</Text>
      ...
      <Text fontSize={"60%"} pl={"10rem"} filter={pinkShadow} color={"rgb(173,123,223)"}>{selectedText[41]}</Text>
      <Text fontSize={"60%"} pl={"11rem"} filter={pinkShadow} color={"rgb(173,123,223)"}>{selectedText[42]}</Text>
      <Text fontSize={"60%"} pl={"12rem"} filter={pinkShadow} color={"rgb(173,123,223)"}>{selectedText[43]}</Text>
      <Text fontSize={"60%"} pl={"13rem"} filter={pinkShadow} color={"rgb(173,123,223)"}>{selectedText[44]}</Text>
      <Text fontSize={"60%"} pl={"15rem"} filter={pinkShadow} color={"rgb(173,123,223)"}>{selectedText[45]}</Text>
